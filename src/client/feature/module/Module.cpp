...
std::shared_ptr<Setting> Module::addEnumSetting(std::string const& internalName, std::wstring const& displayName,
...
std::shared_ptr<Setting> Module::addEnumSetting(std::string const& internalName, LocalizedString const& displayName,
                                                std::wstring const& desc, EnumData& dat, Setting::Condition condition) {
    auto set = std::make_shared<Setting>(internalName, displayName, desc, condition);
    set->enumData = &dat;
    set->value = dat.getValue();
...
std::shared_ptr<Setting> Module::addSliderSetting(std::string const& internalName, std::wstring const& displayName,
...
std::shared_ptr<Setting> Module::addSliderSetting(std::string const& internalName, LocalizedString const& displayName,
                                                  std::wstring const& desc, ValueType& val, ValueType min,
                                                  ValueType max, ValueType interval, Setting::Condition condition) {
    auto set = std::make_shared<Setting>(internalName, displayName, desc, condition);
    set->value = &val;
